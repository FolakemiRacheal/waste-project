...
<body>
    <div class="container">
        <div class="header">
            <h1>Welcome to RECYCLEPAY!\n Resent Verfication Mail</h1>
        </div>
        <div class="content">
            <p>Hello ${fullName},</p>
            <p>Thank you for signing up on our platform. We are excited to have you on board.</p>
...
module.exports = {signUpTemplate,verifyTemplate,forgotPasswordTemplate,pickUpWasteTemplate,resendVerificationEmailTemplate}